...
<section class="section_contents">   
	<iframe width="100%" height="70%" src="https://www.youtube.com/embed/-QX4vd5xARQ" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
	<p>
		황금볶음밥 : 집에서도 고슬고슬한 볶음밥을 만드는 꿀팁
		<!-- 찜 확인 -->                     
	...
	<div id="menu_recipe" style="display:block">
		<p>
			[황금볶음밥]<br>즉석밥<br>계란 두개<br>쪽파 혹은 대파<br>
			치킨스톡 혹은 굴소스 1T<br>식용유 1T<br><br>         
		</p>
	</div>
