...
<section class="section_contents">   
	<iframe width="100%" height="70%" src="https://www.youtube.com/embed/lLkF22Q7e0k" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
	<p>
		스팸 김치볶음밥 : 편의점 재료로 만드는 김치볶음밥 황금레시피
		<!-- 찜 확인 -->                     
	...
	<div id="menu_recipe" style="display:block"> 
		<p>
			[스팸 김치볶음밥]<br>슬라이스 스팸 1통<br>맛김치 2봉지<br>라면 스프 1개<br>
			햇반 1개<br>버터 1덩이<br>스트링 치즈 2개<br>
			대파 1대<br>마늘 2알<br>식용유 약간<br><br>         
		</p> 
	</div>
