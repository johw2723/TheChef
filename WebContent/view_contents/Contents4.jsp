...
<section class="section_contents">   
	<iframe width="100%" height="70%" src="https://www.youtube.com/embed/rO9AJx_AiwY" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
	<p>
		치즈 스테이크를 얹은 알리오 올리오 : 기본 알리오올리오 풍미 200% 끌어올리는 방법
		<!-- 찜 확인 -->                     
	...
	<div id="menu_recipe" style="display:block"> 
		<p>
			[알리오올리오]<br>파스타 면<br>마늘 30알<br>소금(물 100 : 파스타면 10: 소금 1 비율)<br>
			크러쉬드 페퍼 1T<br>파슬리 가루<br>올리브 오일<br><br>
			[스테이크]<br>살치살 300g<br>블루치즈 50g<br>레지아노 치즈 (많이)<br>
			버터<br>브렌디(위스키 가능)<br>후추<br>소금<br>올리브 오일<br><br>         
		</p>
	</div>
