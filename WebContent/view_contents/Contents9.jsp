...
<section class="section_contents">   
	<iframe width="100%" height="70%" src="https://www.youtube.com/embed/r2cY8GobZcU" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
	<p>
		유린기 : 처음 해보는 사람도 가능한 유린기 레시피
		<!-- 찜 확인 -->                     
	...
	<div id="menu_recipe" style="display:block"> 
		<p>
			[유린기]<br>닭다리살 700g<br>양상추 반통<br>감자전분(전분함류 90% 이상) 7T (닭다리살과 100g : 1T 비율) 2회<br>계란 2개<br>식용유<br><br>
			[소스]<br>고추<br>식초 3T<br>간장 3T<br>치킨스톡 1t<br>물 4T<br>올리고당 3T<br><br>         
		</p>
	</div>
